...
import com.thaprobit.resengine.controller.*;
import com.thaprobit.resengine.controller.sys.*;
...
public class HATEOASProvider {
    ...
    public static Link sysEventSelfLinkProvider(int id) {
        return linkTo(methodOn(SysEventController.class).getEvent(id)).withSelfRel();
    }
